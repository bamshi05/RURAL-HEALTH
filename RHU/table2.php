                ...
                <div class="section__content section__content--p30" style="left: -10px" >
                    <div class="container-fluid">
                        ...
                        <div style="padding-left: 480px">
                            <button name="delete"><a href="table2del.php"  class="btn btn-danger">Delete Evaluation</a></button>
                        </div>
                       </div>
...
<script>
     ...
     $("#tablebody").append("<tr><td>"+ Id +"</td><td>"+ User +"</td><td>"+ Rating +"</td><td><textarea>"+ Feedback +"</textarea></td></tr>");                                            
     });                                           
     </script>
