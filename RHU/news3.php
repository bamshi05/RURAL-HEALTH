...
<body class="animsition">
                ...
                <div class="section__content section__content--p30" style="left: -10px" >
                    <div class="container-fluid">
                        ...
                        <button class="au-btn au-btn-icon au-btn--blue" id="add">
                            ...
                            <button id="update" class="btn btn-success" style="color: white">Update Article</button>
                            <a href="news2.php"><button class="btn btn-danger" style="color: white">Delete Article</button></a>
                        </div>
                    </div>
		   ...
		   <div class="modal_bg " id="modal_bg">
			   <div class="modal_main" id="modal_main">
				   <div class="modal-header" style="margin-bottom: 70px">
                    <h3 style= "color: #007bff" style="margin-left: 315px;width: 100px;height:50px;position: absolute;">ADD ARTICLE</h3>
			...
			<div class="modal-body">
				...
				<form class="form" style="color: black" action="" method="POST">
                    ...
                    ARTICLE: <textarea type="text"  name="article" id="article" class="form-control " cols="30" rows="4"></textarea><br>
   ...
   <div class="modal" id="mymodal">
       <div class="modal_bg " id="modal_bg">
         <div class="modal_main" id="modal_main">
           <div class="modal-header" style="margin-bottom: 70px">
             <h3 style= "color: #28a745" style="margin-left: 315px;width: 100px;height:50px;position: absolute">UPDATE ARTICLE</h3>
          <span onclick="document.getElementById('mymodal').style.display='none'" class="close"><button style="color: #28a745">&times;</button></span>
        </div>
      <div class="modal-body">
        
        <form class="form" style="color: black" action="" method="POST">
          <img id="updatedisplay" class="updatedisplay"><br>
                    PICTURE:<br><input type="file" name="picture" id="picture3" required ><br>
                    ARTICLE: <textarea type="text"  name="article" id="article1" class="form-control " cols="30" rows="4"></textarea><br>
...
<script>
    firebase.database().ref().child('news').on("child_added", snap =>{
    ...
    var Image = "Image";
    var myimage = "myImg";
    $("#tablebody").append("<tr><td><input type="+cb+" class="+tog+" value="+Id+"></td><td class="+tog1+">"+ Id +"</td><td class="+size+"><img id="+myimage+" class="+togImg+" src="+ Picture +" alt = "+Image+"></td><td><textarea class="+articclass+" rows="+sizerow+" cols="+sizecol+">"+ Article +"</textarea></td></tr>"); 
...
$('#update').click(function(){
    ...
    checkboxes = document.getElementsByClassName('foo');
     ...
     if(checkboxes[i].checked){
        ...
        articleval = checkboxes[i].parentNode.parentNode.querySelector(".articclass").value;
        document.getElementById("article1").value= articleval;
...
function add_data(){
    ...
    var storageRef = firebase.storage().ref('/images2/' + filename);
    ...
    uploadTask.on('state_changed', function(snapshot){
          ...
          // For instance, get the download URL: https://firebasestorage.googleapis.com/...
           uploadTask.snapshot.ref.getDownloadURL().then( 
            ...
            var a=highest+1;
            firebase.database().ref().child('news/'+ a).set({
              id: a,
              article: articleval,
              picture: image_url
            });
...
function update_data(){
     checkboxes = document.getElementsByClassName('foo');
          ...
          storageRef.child('/images2/'+name).delete().then(function() {
            });
          }
        }        
    var filename = selectedFile.name;
    ...
    uploadTask.on('state_changed', function(snapshot){
          ...
          // For instance, get the download URL: https://firebasestorage.googleapis.com/...
           uploadTask.snapshot.ref.getDownloadURL().then( 
            ...
            var image_url =  downloadURL;
            var articleval = document.getElementById("article1").value;
            
            firebase.database().ref().child('news/'+ idValue).set({
              id: idValue,
              article: articleval,
              picture: image_url
            });
              ...
              // print the image url  
               alert("Data Updated!!!");
               window.location.replace("news3.php");
            }); 
        });
  }
</script>
