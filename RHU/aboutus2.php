                ...
                <div class="section__content section__content--p30" style="left: -10px" >
                    <div class="container-fluid">
                        ...
                        <button class="au-btn au-btn-icon au-btn--blue" id="add">
                            ...
                            <button name="update"><a href="updateaboutus.php" class="btn btn-success">Update Story</a></button>
                            <button onclick="deletedata()"><a href=""  class="btn btn-danger">Delete Story</a></button>
                        </div>
                       </div> 
           ...
           <div class="modal_bg " id="modal_bg">
               <div class="modal_main" id="modal_main">
                   <div class="modal-header" style="margin-bottom: 70px">
                    <h3 style= "color: green" style="margin-left: 315px;width: 100px;height:50px;position: absolute;">ADD STORY</h3>
            ...
            <div class="modal-body">
                ...
                <div class="col-md-12 form-group">
                  <label class="text-black font-weight-bold" for="notes">STORY</label>
                  <textarea type="text"  name="article" class="form-control " cols="30" rows="7"></textarea>
                </div>
              </div>

                    <input type="submit" name="submit" value="ADD ITEM" style="margin-left: 530px;width: 100px;height:50px;position: absolute;" class="btn-success" >
...
<script>
     firebase.database().ref().child('2/data').on("child_added", snap =>{                                           
     ...
     var cb="checkbox";
     var tog="foo";
     $("#tablebody").append("<tr><td><input type="+cb+" class="+tog+" value="+Id+"></td><td>"+ Id +"</td><td width="+wid+"><textarea>"+ Article +"</textarea></td></tr>");                                            
     });                                           
 </script>
...
function deletedata(){
     ...
     if(checkboxes[i].checked){
        ...
        firebase.database().ref("2/data").child(checkedValue).remove();
    } 
    }
  }    
function logout(){
