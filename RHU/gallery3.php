            ...
            <div class="main-content">
                <div class="section__content section__content--p30" style="left: -10px" >
                    <div class="container-fluid">
                        ...
                        <button id="update" class="btn btn-success" style="color: white">Update Gallery</button>
                        <a href="news2.php"><button class="btn btn-danger" style="color: white">Delete Gallery</button></a>
                        </div>
                       </div> 
           ...
           <div class="modal_bg " id="modal_bg">
            ...
            <div class="modal-body">
                ...
                <form class="form" style="color: black" action="" method="POST">
                    ...
                    DESCRIPTION: <textarea type="text"  name="description1" id="description1" class="form-control " cols="30" rows="4"></textarea><br>
  ...
  <script src="js/main.js"></script>
    <div class="modal" id="mymodal">
           <div class="modal_bg " id="modal_bg">
               <div class="modal_main" id="modal_main">
                   <div class="modal-header" style="margin-bottom: 70px">
                    <h3 style= "color: #007bff" style="margin-left: 315px;width: 100px;height:50px;position: absolute;">UPDATE GALLERY</h3>
                    <span onclick="document.getElementById('mymodal').style.display='none'" class="close"><button style="color: blue">&times;</button></span>
                </div>
            <div class="modal-body">
                
                <form class="form" style="color: black" action="" method="POST">
                    <img id="updatedisplay" class="updatedisplay"><br>
                    PICTURE:<br><input type="file" name="picture3" id="picture3" required ><br>
                    ...
                    <button style="margin-left: 37%;width: 118px;height:50px;position: absolute;" class="btn btn-primary" onclick="update_data()">UPDATE ITEM</button>
                </form>
            </div>
...
<script>
    ...
    var Image = "Image";
    var myimage = "myImg";
    $("#tablebody").append("<tr><td><input type="+cb+" class="+tog+" value="+Id+"></td><td class="+tog1+">"+ Id +"</td><td class="+size+"><img id="+myimage+" class="+togImg+" src="+ Picture +" alt = "+Image+"></td><td><textarea class="+articclass+" rows="+sizerow+" cols="+sizecol+">"+ Description +"</textarea></td></tr>"); 
...
$('#update').click(function(){
    ...
    checkboxes = document.getElementsByClassName('foo');
     ...
     if(checkboxes[i].checked){
        ...
        document.getElementById("description").value= articleval;
          ...
          // For instance, get the download URL: https://firebasestorage.googleapis.com/...
           uploadTask.snapshot.ref.getDownloadURL().then( 
            ...
            firebase.database().ref().child('news/'+ idValue).set({
              ...
              // print the image url  
               alert("Data Updated!!!");
               window.location.replace("gallery3.php");
            }); 
        });
  }
</script>
