            ...
            <div class="main-content">
                <div class="section__content section__content--p30" style="left: -10px" >
                    <div class="container-fluid">
                        ...
                        <a href="gallery2.php" class="btn btn-danger"><button name="delete" style="color: white">Delete Gallery</button></a>
                        </div>
                       </div> 
...
<script>
    ...
    var Image = "Image";
    var myimage = "myImg";
    $("#tablebody").append("<tr><td class="+tog+">"+ Id +"</td><td class="+size+"><img id="+myimage+" src="+ Picture +" alt = "+Image+"></td><td><textarea rows="+sizerow+" cols="+sizecol+">"+ Description +"</textarea></td></tr>"); 
