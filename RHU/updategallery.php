...
<?php
	...
	$query = "UPDATE `gallerydb` SET `picture`='".$picture."',`description`='".$description."' WHERE `id` = $id";
		   ...
		   <div class="modal_bg " id="modal_bg2">
			   <div class="modal_main" id="modal_main2">
				   <div class="modal-header" style="margin-bottom: 70px">
					<span class="close"><a href="gallery.php" style="text-decoration: none">&times;</a></span>
				</div>
			<div class="modal-body">
				...
				<form style="color: black" action="" method="GET">
					...
					<h4 style="margin-left: 400px">PICTURE</h4><input type="file" name="picture" style="position: absolute;margin-left: 350px" required value="<?php echo  $_GET['picture'];?>"><br><br><br>
					 DESCRIPTION<textarea type="text" name="description" cols="62.7" rows="13" style="position: absolute;margin-left:90px" required ><?php  echo $_GET['description'];?></textarea><br><br>
