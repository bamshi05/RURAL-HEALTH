...
<body class="animsition">
                ...
                <div class="section__content section__content--p30" style="left: -10px" >
                    <div class="container-fluid">
                        ...
                        <button class="au-btn au-btn-icon au-btn--blue" id="add">
                            ...
                            <button id="update" class="btn btn-success" style="color: white">Update Contact</button>
                            <a href="contact2.php"><button class="btn btn-danger" style="color: white">Delete Contact</button></a>
                        </div>
                       </div> 
           ...
           <div class="modal_bg " id="modal_bg">
               <div class="modal_main" id="modal_main">
                   <div class="modal-header" style="margin-bottom: 70px">
                    <h3 style= "color: #007bff" style="margin-left: 315px;width: 100px;height:50px;position: absolute;">ADD CONTACTS</h3>
            ...
            <div class="modal-body">
                ...
                <form class="form" style="color: black" action="" method="POST">
                  TEL. NO: <input type="number" id="number" style=" position: absolute;margin-left: 40px"><br><br>
                  <input type="text" class="ss" id="ss" style="position: absolute;margin-left: 44px" required >
                <button style="margin-left: 35%;width: 100px;height:50px;position: absolute;" class="btn btn-primary" onclick="add_data()">ADD ITEM</button>
                </form>
            </div>
    ...
    <div class="modal" id="mymodal">
           <div class="modal_bg " id="modal_bg">
               <div class="modal_main" id="modal_main">
                   <div class="modal-header" style="margin-bottom: 70px">
                    <h3 style= "color: #28a745" style="margin-left: 315px;width: 100px;height:50px;position: absolute;">UPDATE CONTACTS</h3>
                    <span onclick="document.getElementById('mymodal').style.display='none'" class="close"><button style="color: #28a745">&times;</button></span>
                </div>
            <div class="modal-body">
                
                <form class="form" style="color: black" action="" method="POST">
                  TEL. NO: <input type="number" id="number3" style=" position: absolute;margin-left: 40px"><br><br>
...
<script>
  ...
  firebase.initializeApp(firebaseConfig);
    ...
    <script>
     firebase.database().ref().child('contact').on("child_added", snap =>{                                           
     ...
     var num1 = "num1";
     var tog1="foo1";
     $("#tablebody").append("<tr><td><input type="+cb+" class="+tog+" value="+Id+" required></td><td class="+tog1+">"+ Id +"</td><td></td><td class="+num1+">"+ Numb +"</td></tr>");
     var rowCount = $('#tablebody >tr').length;
     document.getElementById("myspan3a").innerHTML=rowCount;
...
$('#update').click(function(){
    ...
    checkboxes = document.getElementsByClassName('foo');
     ...
     if(checkboxes[i].checked){
        ...
        priceValue = checkboxes[i].parentNode.parentNode.querySelector(".num1").innerText;
        document.getElementById("number3").value= priceValue;
        $('#mymodal').fadeIn();
        $('#modal_main').show();
      }
    }
...
function add_data(){
            ...
            var a=highest+1;
            firebase.database().ref().child('contact/'+ a).set({
              id: a,
              number: con
            }).then(function() {
...
function update_data(){
            var numnew = document.getElementById("number3").value;
            firebase.database().ref().child('contact/'+ idValue).set({
              id: idValue,
              number: numnew
            }).then(function() {
                alert("Data Updated!!!");
                window.location.replace("contact3.php");
            });
}                              
     </script>                                                                               
