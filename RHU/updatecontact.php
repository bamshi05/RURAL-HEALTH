...
<?php
	...
	$query = "UPDATE `contactdb` SET `number`='".$number."' WHERE `id` = $id";
		   ...
		   <div class="modal_bg " id="modal_bg2">
			...
			<div class="modal-body">
				...
				<form style="color: black" action="" method="GET">
					...
					NUMBER <input type="number" name="number" style="position: absolute;margin-left: 88px" required value="<?php echo  $_GET['number'];?>"><br><br>
